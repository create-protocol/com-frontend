    ...
    <>
      <header
        className={`js-page-header fixed top-0 z-30 w-full bg-[#FFF] dark:dark:bg-[#000] backdrop-blur transition-colors ${
          scrolled
            ? "js-page-header--is-sticky bg-[#000]/5 dark:bg-[#FFF]/5"
            : ""
        }`}
      >
        <div className="flex items-center px-6 py-6 xl:px-12 xxl:px-24 gap-6">
          ...
          <Link
            href="/"
            className="flex items-center gap-1 font-display text-base text-[#4A4A4A]  dark:text-white  h-fit"
          >
            {/*COM*/}
            <Image
              width={65}
          ...
          <div className="flex-1 js-mobile-menu invisible lg:visible fixed inset-0 z-10 ml-auto rtl:mr-auto rtl:ml-0 lg:justify-between items-center bg-white opacity-0 dark:bg-[#4A4A4A] lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent ">
            ...
            <div className="t-0 fixed left-0 z-10 flex w-full items-center justify-between bg-white p-6 dark:bg-jacarta-800 lg:hidden">
              ...
              <Link
                href="/"
                className=" font-display text-2xl text-[#4A4A4A] dark:text-white lg:text-3xl xl:text-4xl h-fit"
              >
                {/*COM*/}
                <Image
                  width={65}
            ...
            {/* Actions */}
            <div className="ml-8  hidden lg:flex xl:ml-12 items-center">
          ...
          {/* Mobile Menu Actions */}
          <div className="ml-auto flex lg:hidden rtl:ml-0 rtl:mr-auto items-center">
            {/* Profile */}
            {/*<Link*/}
            {/*  href="/edit-profile"*/}
