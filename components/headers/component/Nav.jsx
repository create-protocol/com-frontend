    ...
    <>
      <li className="group">
        <Link
            ...
            }  hover:text-[#03b56a] focus:text-[#03b56a] dark:hover:text-[#03b56a] dark:focus:text-[#03b56a] lg:px-4`}
        >
          Home
        </Link>
      </li>
      ...
      <li className="group">
        <Link
            ...
            target='_blank'
            className={`flex items-center justify-between py-3.5 font-display text-base text-[#4A4A4A] dark:text-white hover:text-[#03b56a] dark:hover:text-[#03b56a] lg:px-4`}
        >
          Developer
        </Link>
      </li>
