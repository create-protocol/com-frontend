        ...
        <div className="py-16 text-center">
          ...
          {/*</p>*/}
            <p className="mb-8 text-lg dark:text-jacarta-200">
                Open new possibilities for your users with AI x Blockchain x Creativity
            </p>
            <div className="text-center my-6">
                <span className="text-xl font-bold">{staticText}</span>
                <span className="min-w-[100px] text-xl font-bold text-[#03b56a] transition-transform transform-gpu duration-500 ease-in-out">
