...
export default function Hero2() {
  ...
  let staticText = t("home").hero2.static;
  let dynamicTexts = [
    t("home").hero2.dynamic.davinci,
    t("home").hero2.dynamic.tagore,
    t("home").hero2.dynamic.beethoven,
  ];
      ...
      <div className="container">
        <div className="py-16 text-center">
          ...
          <div className="text-center my-6">
            ...
            <span className="text-xl font-bold text-[#03b56a] transition-transform transform-gpu duration-500 ease-in-out">
        ...
        <div className="relative">
          ...
          >
            {collections2.map((elm, i) => (
              <SwiperSlide key={i}>
                <article>
                  <div className="block overflow-hidden rounded-2.5xl bg-white shadow-md transition-shadow hover:shadow-lg dark:bg-[#4A4A4A]">
                      ...
                      <div className="flex">
                        ...
                        <div>
                          <Link href={`/explore/${elm.id}`} className="block">
                            <span className="font-display text-lg leading-none text-jacarta-700 hover:text-[#03b56a] dark:text-white">
                              {elm.title}
                            </span>
                          </Link>
