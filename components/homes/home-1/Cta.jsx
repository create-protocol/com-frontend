          ...
          <div className="mb-12 lg:w-1/2">
            <div className="rounded-2.5xl bg-white p-12 dark:bg-[#4A4A4A]">
              ...
              <div className="flex space-x-2">
                <a
                  href="#"
                  className="group inline-flex h-10 w-10 items-center justify-center rounded-2lg border-2 border-[#03b56a]-lighter hover:border-[#03b56a] hover:bg-[#03b56a]"
                >
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
                    data-icon="twitter"
                    className="h-5 w-5 fill-[#03b56a] group-hover:fill-white dark:group-hover:fill-white"
                    role="img"
