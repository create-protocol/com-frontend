            ...
            <form onSubmit={(e) => e.preventDefault()}>
              <div className="flex space-x-7">
                <div className="mb-6 w-1/2">
                  ...
                  <input
                    name="name"
                    className="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-[#03b56a]/10 focus:ring-[#03b56a] dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300"
                    id="name"
                    type="text"
                    required
                  />
              ...
              <div className="mb-6 flex items-center space-x-2">
                <input
                  ...
                  name="agree-to-terms"
                  className="h-5 w-5 self-start rounded border-jacarta-200 text-[#03b56a] checked:bg-[#03b56a] focus:ring-[#03b56a]/20 focus:ring-offset-0 dark:border-jacarta-500 dark:bg-jacarta-600"
                />
                <label
                ...
                >
                  I agree to the{" "}
                  <Link href="/tos" className="text-[#03b56a]">
                    Terms of Service
                  </Link>
                </label>
              </div>
