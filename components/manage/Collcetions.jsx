    ...
    <section className="relative py-24 pt-20 h-full">
      ...
      <div className="container h-full">
        ...
        {isConnecting || isReconnecting ? (
          ...
          <p className="w-full h-full text-center dark:text-[#FFFFFF]">
            Please connect your wallet to manage your COMs.
          </p>
        ) : (
          <div className="h-full w-full flex flex-col sm:flex-row gap-4">
            ...
            >
              <li className="nav-item" role="presentation">
                <button
                  className="nav2-link active relative flex items-center whitespace-nowrap py-3 px-6 pe-12 text-jacarta-400 hover:text-jacarta-700 dark:hover:text-white"
                  id="on-sale-tab"
                  data-bs-toggle="tab"
