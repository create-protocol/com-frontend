            ...
            <div className="mx-auto max-w-[48.125rem]">
              ...
              <div className="mb-6">
                ...
                <input
                    type="text"
                    id="item-name"
                    className="w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-[#03b56a]/10 focus:ring-[#03b56a] dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300"
              ...
              <div className="relative">
                ...
                <div className="dropdown my-1 cursor-pointer">
                  <div
                      ...
                      aria-expanded="false"
                  >
                    <span className="">{currcentCollection ? currcentCollection.name:'Select com 1'}</span>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="24"
                ...
                <div className="dropdown my-4 cursor-pointer">
                  <div
                      ...
                      aria-expanded="false"
                  >
                    <span className="">{currcentCollection2 ? currcentCollection2.name:'Select com 2'}</span>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        width="24"
